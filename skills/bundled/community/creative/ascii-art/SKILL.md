...
```bash
python3 -m pyfiglet "VOICEOS" -f slant | boxes -d stone
# Or without pyfiglet installed:
curl -s "https://asciified.thelicato.io/api/v2/ascii?text=VOICEOS&font=Slant" | boxes -d stone
```
